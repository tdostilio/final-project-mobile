    ...
    return (
      <View style={styles.container}>
        <View style={styles.titleContainer}>
            <Text style={styles.title}>What group would you like to add <Text style={{color: '#1FFFDA'}}>{this.state.information.givenName + ' ' + this.state.information.familyName} to?</Text>
        </View>
        <ScrollView>
